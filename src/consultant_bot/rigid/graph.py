"""Builds the rigid (flow-based) architecture's StateGraph.
...
from consultant_bot.rigid.nodes.ask_entity import ask_entity
from consultant_bot.rigid.nodes.canned import fallback, idle_reply
from consultant_bot.rigid.nodes.capture_entity import capture_entity
from consultant_bot.rigid.nodes.product_search import build_product_search_node
from consultant_bot.rigid.nodes.route_intent import (
    IntentLabel,
    build_default_classifier,
    build_route_intent_node,
    route_after_intent,
)
from consultant_bot.rigid.nodes.suggestion import build_suggestion_node
