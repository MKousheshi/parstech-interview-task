"""Builds the agentic (tool-calling) architecture's StateGraph: the real node topology.
...
`docs/ARCHITECTURE_AGENTIC.md` for the full per-node behavioral spec.
"""
...
from consultant_bot.agentic.nodes.analysis import build_analysis_node
from consultant_bot.agentic.nodes.assistant import build_assistant_node
from consultant_bot.agentic.nodes.completion_check import completion_check
from consultant_bot.agentic.nodes.extract_entities import (
    build_default_extractor,
    build_extract_entities_node,
)
from consultant_bot.agentic.nodes.suggestion import build_query_formulator, build_suggestion_node
