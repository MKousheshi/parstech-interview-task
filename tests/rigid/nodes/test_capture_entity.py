...
from consultant_bot.rigid.nodes.ask_entity import next_missing_field
...
def test_an_off_topic_reply_is_stored_verbatim() -> None:
    # The rigid design's documented limitation: a pending field swallows whatever comes next.
